...
void draw(){
  ...
  if (checkForNewData()){
    /*
    cyt1 = lerp(cyt1, map(t1, 0, 50, 0, -100), 0.8) ;
    cyt2 = lerp(cyt2, map(t2, 0, 50, 0, -100), 0.8);
    cyt3 = lerp(cyt2, map(t3, 0, 50, 0, -100), 0.8);
    cyh1 = lerp(cyh1, -1*h1, 0.8);
    cyh2 = lerp(cyh2, -1*h2, 0.8);
    cyh3 = lerp(cyh3, -1*h3, 0.8);
    cyv1 = lerp(cyv1, map(dv1, 0, 64, 0, 100), 0.8);
    cyv2 = lerp(cyv2, map(dv2, 0, 64, 0, 100), 0.8);
    cyv3 = lerp(cyv3, map(dv3, 0, 64, 0, 100), 0.8);*/
